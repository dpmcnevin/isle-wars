...
// https://<user>.github.io/<repo>/. Set to '' for a custom-domain deploy, or
// in dev (ios/bridge imports src/lib directly rather than going through this
// build at all, so it never hits this path).
